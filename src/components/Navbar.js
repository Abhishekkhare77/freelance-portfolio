      ...
      <nav className='bg-black fixed top-0 w-full'>
        <div className='flex justify-between items-center'>
          ...
          <ul className='hidden md:flex items-center justify-center m-2'>
            <li  onClick={(e)=>e.scrollIntoView({behavior:'smooth'})} className='p-2 cursor-pointer text-xl font-semibold hover:text-purple-400 transition-all ease-in-out'>Home</li>
            <li onClick={()=>{}}  className='p-2 cursor-pointer text-xl font-semibold hover:text-purple-400 transition-all ease-in-out'>About</li>
            <li  onClick={()=>{}} className='p-2 cursor-pointer text-xl font-semibold hover:text-purple-400 transition-all ease-in-out'>Services</li>
            <li  onClick={()=>{}} className='p-2 cursor-pointer text-xl font-semibold hover:text-purple-400 transition-all ease-in-out'>Projects</li>
            <li  onClick={()=>{}} className='p-2 cursor-pointer text-xl font-semibold hover:text-purple-400 transition-all ease-in-out'>Contact</li>
          </ul>
        </div>
